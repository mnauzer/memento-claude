 ...
 * Názov:       DenRep.Trigger.Calculate
 * Typ:         Trigger (Before Save)
 * Verzia:      1.0.0
 * Event:       newEntryBeforeSave, updateEntryBeforeSave
 *
 * Popis:
 * Trigger script, ktorý volá DennyReport modul pre auto-linkovanie,
 * validáciu a prepočet Denného reportu. Spúšťa sa pri každom uložení.
 *
 * Závislosti:
 ...
 * - MementoConfig 8.0+
 * - MementoCore 8.0+
 * - MementoBusiness 8.2.0+ (race condition fix)
 *
 * Autor:       ASISTANTO
...
var SCRIPT_NAME = "DenRep.Trigger.Calculate";
